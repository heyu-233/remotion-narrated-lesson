...
const T_TITLE_IN = anchorStart("lesson.hook");
const T_TITLE_HOLD = anchorStart("lesson.explain");
const T_CODE_IN = anchorStart("lesson.detail");
const T_CODE_HIGHLIGHT = anchorStart("lesson.highlight");
const T_END = anchorEnd("lesson.summary");
